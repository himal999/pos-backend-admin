...
public class BillingSpecification {
    public static Specification<Billing> getSpecification(CustomerSearchDTO filterDto, Customer customer) {
        ...
        return (root, query, criteriaBuilder) -> {
            ...
            if(filterDto.getPaymentCategory() != null && !filterDto.getPaymentCategory().isEmpty()) {
                predicates.add(criteriaBuilder.equal(root.get("paymentCategory"), PaymentCategory.valueOf(filterDto.getPaymentCategory())));
            }
    ...
    public static Specification<Billing> getSpecification(Customer customer) {
