...
public interface PageService {
    ...
    ResponseEntity<ApiResponse<Object>> view(PageRequestDTO pageRequestDTO, Locale locale);
    ResponseEntity<ApiResponse<Object>> update(PageRequestDTO pageRequestDTO, Locale locale);
    ResponseEntity<ApiResponse<Object>> delete(PageRequestDTO pageRequestDTO, Locale locale);
}
