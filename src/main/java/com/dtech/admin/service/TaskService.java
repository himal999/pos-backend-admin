...
public interface TaskService {
    ...
    ResponseEntity<ApiResponse<Object>> view(TaskRequestDTO taskRequestDTO, Locale locale);
    ResponseEntity<ApiResponse<Object>> update(TaskRequestDTO taskRequestDTO, Locale locale);
    ResponseEntity<ApiResponse<Object>> delete(TaskRequestDTO taskRequestDTO, Locale locale);
}
